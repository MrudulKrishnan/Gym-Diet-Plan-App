...
public class registration extends AppCompatActivity {
    EditText firstname, lastname, age, place, post, pin, phone, email, username, password, proof,
            height, weight;
    RadioButton male, female;
    Button butt_signup, butt_proof;
    String firstname_str, lastname_str, age_str, gender_str, place_str, post_str, pin_str, phone_str,
            email_str, proof_str, height_str, weight_str, username_str, password_str, url, title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        height = findViewById(R.id.e12_Height);
        weight = findViewById(R.id.e13_Weight);
...
//            intent.setType("application/pdf");
        ...
        butt_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (weight_str.equalsIgnoreCase("")) {
                    weight.setError("Enter Your email");
                } else if (height_str.equalsIgnoreCase("")) {
                    height.setError("Enter Your phone");
