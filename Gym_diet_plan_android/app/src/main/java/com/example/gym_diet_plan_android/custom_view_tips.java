...
class custom_view_tips extends BaseAdapter {
...
//    ArrayList<String> e;
    ...
    public custom_view_tips(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d ) {
...
//        this.e=e;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_tips,null);
