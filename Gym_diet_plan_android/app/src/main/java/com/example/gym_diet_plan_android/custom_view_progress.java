...
class custom_view_progress extends BaseAdapter {
    ...
    public custom_view_progress(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d, ArrayList<String> e ) {
...
//        this.b=b;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_progress,null);
